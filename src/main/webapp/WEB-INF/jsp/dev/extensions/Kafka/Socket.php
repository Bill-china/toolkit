...
{
    // {{{ consts
    //该参数要>MyClient.php private $max_bytes_ = 10240000; 
    const READ_MAX_LEN = 10485760; // read socket max length 10MB
    ...
    public function connect()
    {
        ...
        if (empty($this->host)) {
            ...
            Log::write(Log::ERROR, "cannot open null host");
            return false;
        }
        if ($this->port <= 0) {

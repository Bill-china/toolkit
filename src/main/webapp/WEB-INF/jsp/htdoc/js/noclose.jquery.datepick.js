...
$.extend(Datepick.prototype, {
		...
		if (this._datepickerShowing) {
			...
			if (duration != '' && $.effects && $.effects[showAnim])
				...
				//inst.dpDiv[(duration == '' ? 'hide' : (showAnim == 'slideDown' ? 'slideUp' :
					...
					inst.dpDiv[(duration == '' ? 'hide' : (showAnim == 'show' ? 'hide' :
					(showAnim == 'show' ? 'hide' : 'hide')))](duration, postProcess);
			if (duration == '')
	...
	_selectDate: function(id, dateStr) {
		...
		if (inst.inline)
            ...
            if(this._get(inst, 'autoHidden') === false){
                this._hideDatepick(null, this._get(inst, 'duration'));    
            }
	...
	_generateHTML: function(inst) {
		...
		var isRTL = this._get(inst, 'isRTL');
/* the next pragraph is close  'cancle' and 'close' */
		...
		var html = '<div class="datepick-links">' + (isRTL ? next : prev) +
